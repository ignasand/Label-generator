...
Machine learning based wine quality predictor (sklearn, pandas) web app (in it's developing stage). [Dateset](https://archive.ics.uci.edu/ml/datasets/wine+quality). Feature number is reduced to 3 to be more user friendly. Logistic Regression classifier accuracy is ~77%
